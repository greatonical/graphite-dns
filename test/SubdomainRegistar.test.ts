...
describe("AuctionRegistrar", function () {
  ...
  beforeEach(async () => {
    ...
    const resFact    = new ethers.ContractFactory(resArt.abi, resArt.bytecode, owner);
    ...
    const regFact    = new ethers.ContractFactory(regArt.abi, regArt.bytecode, owner);
    ...
    const aucFact    = new ethers.ContractFactory(aucArt.abi, aucArt.bytecode, owner);
